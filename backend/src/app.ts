...
//settings
app.set('port', process.env.PORT || 4002); //si tiene puerto ya el servidor con process.env.port usara ese sino el 4000
...
//routes
app.use('/minimExemple',indexRoutes); //cada vez que llegue una ruta a http://localhost:4000/api se manejara con el archivo indexRoutes
